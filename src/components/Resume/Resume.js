          ...
          <Col md={6} className="resume-left">
            ...
            <Resumecontent
              ...
              content={[
                ...
                "motivated,creative and ambitious IT professional looking for an",
                " opportunity to implement my knowledge of web development capabilities with",
                " the aim of leveraging my skills and experience towards my professional",
                " growth, better career and company growth."
              ]}
            />
